...
class ResaleShop:
    ...
    """
    Takes in information about a computer and adds a Computer object to the inventory
    """
    def buy(self, description: str, processor_type: str, hard_drive_capacity: int, memory: int, 
        ...
        self.inventory.append(Computer(description, processor_type, hard_drive_capacity, 
